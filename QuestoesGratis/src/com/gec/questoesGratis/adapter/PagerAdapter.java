...
public final class PagerAdapter extends FragmentStatePagerAdapter {
   ...
   private static final class QuestionFragment extends Fragment implements OnClickListener {
      ...
      private void setup(View view) {
         ...
         Question question = xSel.getQuestion(questionNumber);

         TextView description = (TextView) view.findViewById(R.id.question_description);
         description.setText(question.getCompleteDescription());

         String qp = question.getQuestion();
